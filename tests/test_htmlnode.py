...
from src.htmldode import HTMLNode
from src.htmldode import LeafNode
from src.htmldode import ParentNode
...
class TestHTMLNode(unittest.TestCase):
    ...
    def test_parent_node(self):
        ...
        node1_should_render_as = "<p><b>Bold text</b>Normal text<i>italic text</i>Normal text</p>"
        self.assertEqual(node1.to_html(), node1_should_render_as)
    ...
    def test_nested_parent_node(self):
        ...
        node1_should_render_as = "<p><b>Bold text</b>Normal text<i>italic text</i><p>hello</p></p>"
        self.assertEqual(node1.to_html(), node1_should_render_as)
